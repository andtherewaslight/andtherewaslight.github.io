...
If your browser does not support the iframe showing the app, you may try to open the app on a new window in [this link](https://mybinder.org/v2/gh/andtherewaslight/FIMOC/main?urlpath=%2Fvoila%2Frender%2Ffimoc.ipynb).
