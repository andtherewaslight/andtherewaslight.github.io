...
Welcome to FIMOC, the Fiber Mode Online Calculator, an online calculator of fiber modes. Here you will be able to calculate and visualize the propagating modes of any step-index fiber of your choice.
...
If your browser does not support the iframe showing the app, you may try to open the app on a new window in [this link](https://fimoc.herokuapp.com/).


<!-- [OPEN FIMOC](https://fimoc.herokuapp.com/){:.button.button--primary.button--pill}{:target="_blank"} -->
